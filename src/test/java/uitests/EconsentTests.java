...
public class EconsentTests extends TestBase{
    ...
    public void loginSetup() {
        ...
        uitests.PersonalInformationTests personalInformationTests = new uitests.PersonalInformationTests();
        personalInformationTests.verifyWithValidCredentials();
        uitests.ExpensesTests expensesTests = new uitests.ExpensesTests();
        expensesTests.verifyWithRentCheckBox();
        uitests.EmploymentAndIncomeTests employmentAndIncomeTests = new uitests.EmploymentAndIncomeTests();
        employmentAndIncomeTests.verifyWithValidDataEmploymentAndIncome();
        uitests.CreditReportTest creditReportTest = new uitests.CreditReportTest();
